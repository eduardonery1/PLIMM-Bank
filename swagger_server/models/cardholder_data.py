...
class CardholderData(Model):
    ...
    def __init__(self, cardholder_type: str=None, full_name: str=None, card_data: CardEmbossing=None, identity_document_number: str=None, other_identity_document_number: PersonalIdentityDocumentInfo=None, birth_date: str=None, nationality: str=None, gender: str=None, civil_status: str=None, contact_information: ContactInformation=None):  # noqa: E501
        """CardholderData - a model defined in Swagger

        :param cardholder_type: The cardholder_type of this CardholderData.  # noqa: E501
        :type cardholder_type: str
        :param full_name: The full_name of this CardholderData.  # noqa: E501
        :type full_name: str
        :param card_data: The card_data of this CardholderData.  # noqa: E501
        :type card_data: CardEmbossing
        :param identity_document_number: The identity_document_number of this CardholderData.  # noqa: E501
        :type identity_document_number: str
        :param other_identity_document_number: The other_identity_document_number of this CardholderData.  # noqa: E501
        :type other_identity_document_number: PersonalIdentityDocumentInfo
        :param birth_date: The birth_date of this CardholderData.  # noqa: E501
        :type birth_date: str
        :param nationality: The nationality of this CardholderData.  # noqa: E501
        :type nationality: str
        :param gender: The gender of this CardholderData.  # noqa: E501
        :type gender: str
        :param civil_status: The civil_status of this CardholderData.  # noqa: E501
        :type civil_status: str
        :param contact_information: The contact_information of this CardholderData.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'CardholderData':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The CardholderData of this CardholderData.  # noqa: E501
    ...
    def cardholder_type(self) -> str:
        """Gets the cardholder_type of this CardholderData.

        Tipo de portador (\"main\" - Titular ou \"additional\" - Adicional)  # noqa: E501

        :return: The cardholder_type of this CardholderData.
        :rtype: str
        """
    ...
    def cardholder_type(self, cardholder_type: str):
        """Sets the cardholder_type of this CardholderData.

        Tipo de portador (\"main\" - Titular ou \"additional\" - Adicional)  # noqa: E501

        :param cardholder_type: The cardholder_type of this CardholderData.
        :type cardholder_type: str
        """
    ...
    def full_name(self) -> str:
        """Gets the full_name of this CardholderData.

        Nome completo do portador, ou razão social se for pessoa jurídica.  # noqa: E501

        :return: The full_name of this CardholderData.
        :rtype: str
        """
    ...
    def full_name(self, full_name: str):
        """Sets the full_name of this CardholderData.

        Nome completo do portador, ou razão social se for pessoa jurídica.  # noqa: E501

        :param full_name: The full_name of this CardholderData.
        :type full_name: str
        """
    ...
    def card_data(self) -> CardEmbossing:
        """Gets the card_data of this CardholderData.


        :return: The card_data of this CardholderData.
        :rtype: CardEmbossing
        """
    ...
    def card_data(self, card_data: CardEmbossing):
        """Sets the card_data of this CardholderData.


        :param card_data: The card_data of this CardholderData.
        :type card_data: CardEmbossing
        """
    ...
    def identity_document_number(self) -> str:
        """Gets the identity_document_number of this CardholderData.

        No Brasil, usar CPF ou CNPJ do portador.  # noqa: E501

        :return: The identity_document_number of this CardholderData.
        :rtype: str
        """
    ...
    def identity_document_number(self, identity_document_number: str):
        """Sets the identity_document_number of this CardholderData.

        No Brasil, usar CPF ou CNPJ do portador.  # noqa: E501

        :param identity_document_number: The identity_document_number of this CardholderData.
        :type identity_document_number: str
        """
    ...
    def other_identity_document_number(self) -> PersonalIdentityDocumentInfo:
        """Gets the other_identity_document_number of this CardholderData.


        :return: The other_identity_document_number of this CardholderData.
    ...
    def other_identity_document_number(self, other_identity_document_number: PersonalIdentityDocumentInfo):
        """Sets the other_identity_document_number of this CardholderData.


        :param other_identity_document_number: The other_identity_document_number of this CardholderData.
        :type other_identity_document_number: PersonalIdentityDocumentInfo
        """
    ...
    def birth_date(self) -> str:
        """Gets the birth_date of this CardholderData.

        Data de nascimento no formato dd/MM/yyyy  # noqa: E501

        :return: The birth_date of this CardholderData.
        :rtype: str
        """
    ...
    def birth_date(self, birth_date: str):
        """Sets the birth_date of this CardholderData.

        Data de nascimento no formato dd/MM/yyyy  # noqa: E501

        :param birth_date: The birth_date of this CardholderData.
        :type birth_date: str
        """
    ...
    def nationality(self) -> str:
        """Gets the nationality of this CardholderData.

        Nome do país de nascimento ou de naturalização do portador.  # noqa: E501

        :return: The nationality of this CardholderData.
        :rtype: str
        """
    ...
    def nationality(self, nationality: str):
        """Sets the nationality of this CardholderData.

        Nome do país de nascimento ou de naturalização do portador.  # noqa: E501

        :param nationality: The nationality of this CardholderData.
        :type nationality: str
        """
    ...
    @property
    def gender(self) -> str:
        """Gets the gender of this CardholderData.

        Gênero  # noqa: E501

        :return: The gender of this CardholderData.
        :rtype: str
        """
        return self._gender
    ...
    def gender(self, gender: str):
        """Sets the gender of this CardholderData.

        Gênero  # noqa: E501

        :param gender: The gender of this CardholderData.
        :type gender: str
        """
    ...
    def civil_status(self) -> str:
        """Gets the civil_status of this CardholderData.

        Estado civil.  # noqa: E501

        :return: The civil_status of this CardholderData.
        :rtype: str
        """
    ...
    def civil_status(self, civil_status: str):
        """Sets the civil_status of this CardholderData.

        Estado civil.  # noqa: E501

        :param civil_status: The civil_status of this CardholderData.
        :type civil_status: str
        """
    ...
    def contact_information(self) -> ContactInformation:
        """Gets the contact_information of this CardholderData.


        :return: The contact_information of this CardholderData.
    ...
    def contact_information(self, contact_information: ContactInformation):
        """Sets the contact_information of this CardholderData.


        :param contact_information: The contact_information of this CardholderData.
        :type contact_information: ContactInformation
        """
