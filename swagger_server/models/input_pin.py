...
class InputPin(Model):
    ...
    def __init__(self, id_transport_key: str=None, pin_block: str=None, format: str=None):  # noqa: E501
        """InputPin - a model defined in Swagger

        :param id_transport_key: The id_transport_key of this InputPin.  # noqa: E501
        :type id_transport_key: str
        :param pin_block: The pin_block of this InputPin.  # noqa: E501
        :type pin_block: str
        :param format: The format of this InputPin.  # noqa: E501
        :type format: str
        """
        self.swagger_types = {
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'InputPin':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The InputPin of this InputPin.  # noqa: E501
        :rtype: InputPin
        """
    ...
    def id_transport_key(self, id_transport_key: str):
        """Sets the id_transport_key of this InputPin.

        Identificador da chave de transporte de PIN estabelecido entre emissor e paySmart.  # noqa: E501

        :param id_transport_key: The id_transport_key of this InputPin.
        :type id_transport_key: str
        """
    ...
    def pin_block(self, pin_block: str):
        """Sets the pin_block of this InputPin.

        PIN cifrado pela chave de transporte de identificador [idTransportKey]  # noqa: E501

        :param pin_block: The pin_block of this InputPin.
        :type pin_block: str
        """
    ...
    def format(self, format: str):
        """Sets the format of this InputPin.

        Formato do PINBlock (Opcional - para entrada, apenas ISO-1 é suportado)  # noqa: E501

        :param format: The format of this InputPin.
        :type format: str
        """
