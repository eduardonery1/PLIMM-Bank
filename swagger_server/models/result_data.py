...
class ResultData(Model):
    ...
    def __init__(self, result_code: int=None, result_description: str=None, issuer_request_id: str=None, ps_response_id: str=None):  # noqa: E501
        """ResultData - a model defined in Swagger

        :param result_code: The result_code of this ResultData.  # noqa: E501
        :type result_code: int
        :param result_description: The result_description of this ResultData.  # noqa: E501
        :type result_description: str
        :param issuer_request_id: The issuer_request_id of this ResultData.  # noqa: E501
        :type issuer_request_id: str
        :param ps_response_id: The ps_response_id of this ResultData.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'ResultData':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The ResultData of this ResultData.  # noqa: E501
        :rtype: ResultData
        """
    ...
    def result_code(self) -> int:
        """Gets the result_code of this ResultData.

        Código de resultado do processamento.  # noqa: E501

        :return: The result_code of this ResultData.
        :rtype: int
        """
    ...
    def result_code(self, result_code: int):
        """Sets the result_code of this ResultData.

        Código de resultado do processamento.  # noqa: E501

        :param result_code: The result_code of this ResultData.
        :type result_code: int
        """
    ...
    def result_description(self) -> str:
        """Gets the result_description of this ResultData.

        Descrição textual do resultado do processamento.  # noqa: E501

        :return: The result_description of this ResultData.
        :rtype: str
        """
    ...
    def result_description(self, result_description: str):
        """Sets the result_description of this ResultData.

        Descrição textual do resultado do processamento.  # noqa: E501

        :param result_description: The result_description of this ResultData.
        :type result_description: str
        """
    ...
    def issuer_request_id(self, issuer_request_id: str):
        """Sets the issuer_request_id of this ResultData.

        Identificador único da requisição gerado pelo emissor. Ecoado conforme enviado na requisição.  # noqa: E501

        :param issuer_request_id: The issuer_request_id of this ResultData.
        :type issuer_request_id: str
        """
    ...
    def ps_response_id(self) -> str:
        """Gets the ps_response_id of this ResultData.

        Identificador único da resposta. Gerado pela paySmart.  # noqa: E501

        :return: The ps_response_id of this ResultData.
        :rtype: str
        """
    ...
    def ps_response_id(self, ps_response_id: str):
        """Sets the ps_response_id of this ResultData.

        Identificador único da resposta. Gerado pela paySmart.  # noqa: E501

        :param ps_response_id: The ps_response_id of this ResultData.
        :type ps_response_id: str
        """
